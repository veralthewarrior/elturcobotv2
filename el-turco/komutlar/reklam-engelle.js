...
exports.run = async(client, message, args) => {
  ...
  message.channel.send(`**EL TURCO BOT** | Reklam Filtresi başarıyla ayarlandı komutanım!`)    
  ...
  if (args[0] == 'kapat') {
    ...
    message.channel.send(`**EL TURCO BOT** | Reklam filtresi başarılı bir şekilde kapatıldı komutanım!`)
  }
